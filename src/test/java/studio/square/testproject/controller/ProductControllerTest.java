...
import studio.square.testproject.service.impl.ProductServiceImpl;
...
public class ProductControllerTest {
    ...
    // ProductController에서 잡고 있는 Bean 객체에 대해 Mock 형태의 객체를 생성
    @MockBean
    ...
    void getProductTest() throws Exception {
        ...
        given(productService.getProduct("1234")).willReturn(
                new ProductDto("1414", "pen", 5000, 2000));
